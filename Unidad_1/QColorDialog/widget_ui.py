...
class Ui_Widget(object):
    ...
    def retranslateUi(self, Widget):
        ...
        self.text_color_button.setText(QCoreApplication.translate("Widget", u"Color Texto", None))
        self.background_color_button.setText(QCoreApplication.translate("Widget", u"Background Color", None))
        self.font_button.setText(QCoreApplication.translate("Widget", u"Fuente", None))
